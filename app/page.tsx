      ...
      <div className="mx-auto flex min-h-[calc(100vh-48px)] max-w-6xl flex-col justify-center">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-[var(--muted)]">
            Upload documents, organize projects, and ask grounded questions through a compact, professional research surface.
          </p>

          <div className="mt-7 flex flex-col gap-2 sm:flex-row">
            <Link
              href="/signup"
              className="primary-button px-5 no-underline"
            >
              Get started
            </Link>
            <Link
              href="/login"
              className="secondary-button px-5 no-underline"
            >
              Login
            </Link>
          </div>
